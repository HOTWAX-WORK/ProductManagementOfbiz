        ...
        try {
            ...
            if (newPrice != null) {
                ...
                if (oldPriceRecord != null) {
                    ...
                    delegator.store(oldPriceRecord);
                    ...
                    newPriceRecord.set("productPriceTypeId", "DEFAULT_PRICE");
                    ...
                    Debug.logWarning("No price record found for Product ID " + productId, MODULE);
                }
            }
